...
└── notebooks/
    ├── walmart_linear_regression.ipynb   # Exploratory analysis + Linear Regression
    ├── walmart_random_forest.ipynb       # Random Forest model notebook
    └── walmart_gradient_boosting.ipynb  # Gradient Boosting model notebook
```
...
pip install pandas numpy scikit-learn matplotlib seaborn scipy kagglehub
```
