...
y_pred_train_log = best_ridge.predict(X_train)
y_pred_test_log  = best_ridge.predict(X_test)
...
print('=' * 50)
print('RIDGE REGRESSION — Results (Log Scale)')
print('=' * 50)
...
print()
print('=' * 50)
print('RIDGE REGRESSION — Results (Original Scale)')
print('=' * 50)
...
if gap < 0.02:
    ...
    print("-> Overfitting detected. Try increasing alpha.")
...
axes[0].scatter(y_pred_test_log, residuals, alpha=0.3, s=10, color='purple')
...
axes[1].scatter(y_test_orig, y_pred_test_orig, alpha=0.3, s=10, color='purple')
...
plt.suptitle('Ridge Regression — Diagnostic Plots', fontsize=13, fontweight='bold')
plt.tight_layout()
plt.show()
